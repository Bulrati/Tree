...
public class BTree<T1 extends Comparable<T1>,T2> {
    ...
    BTree<T1,T2> left, right;
    T1 key;
    T2 value;
    BTree(T1 key, T2 value){
        this.key=key;
        this.value=value;
    }
    public BTree(){
    ...
    private BTree<T1,T2> root = null;

    public void add(T1 ke, T2 val){
        BTree<T1,T2> x=root, y = null;
        int cmp=0;
        while(x!=null){
        ...
        BTree<T1,T2> newNode = new BTree<T1,T2>(ke,val);
        if(y==null){
            root=newNode;
        }else{
    ...
    public void delete(T1 ke){
        BTree<T1,T2> x=root,y=null,z=null, del=null, leftNode=null,rightNode=null;
        int cmp = 0;
        boolean pravo = false;
        while(x!=null){
            cmp = ke.compareTo(x.key);
    ...
    private T2 poisk(BTree x, T1 ke){
        BTree<T1,T2> y=null;
        if(x!=null){
    ...
    public T2 breadthSearch(T1 ke){
        ...
        BTree<T1,T2>[] mas=new BTree[1000];
